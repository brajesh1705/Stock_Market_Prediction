...
class Stocker():
    ...
    def __init__(self, ticker,stock, exchange='WIKI'):
    ...
    def create_prophet_model(self, days=0, resample=False):
        ...
        stock_history=stock_history[stock_history['Date'] < (self.max_date - pd.DateOffset(years = 1)).date()]
        if resample:
